...
- (UIImage *)transparentBorderImage:(NSUInteger)borderSize {
    ...
    DLog(@"bitmapInfo=%d, bitsPerComponent=%zd, colorSpace=%@",bitmapInfo, bitsPerComponent,colorSpace);
...
// Create a copy of the image, rotated so that the resulting image is appropriate for UIImageOrientationUp
